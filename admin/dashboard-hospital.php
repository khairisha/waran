...
<div class="dropdown">
  ...
  <button type="button"  class="btn btn-secondary dropdown-toggle" style="width: 200px; background-color:#7571f9" >Hospital Kerajaan</button> 
...
<div class="container bg-white shadow">
    <div class="py-4 mt-5"> 
    <div class='text-center pb-2'><h4>Bilangan Waran Hospital Kerajaan</h4></div>
    ...
    <table class="table datatable">
            ...
            //   $results = mysqli_query($conn, $query);
              ...
              $sql = "SELECT * FROM data_hospital INNER JOIN hospital ON data_hospital.id = hospital.id_hospital";  
              $results = mysqli_query($conn, $sql);
                    while($data_hospital=mysqli_fetch_array($results)){
                    $id=$data_hospital["id"];
                    $i++;
                    echo "<tr>";
                    //echo "<td>".$i."</td>";
                    echo "<td style=\"width:24.3%\">".$data_hospital["hospital"]."</td>";
                    echo "<td style=\"width:9%\" align=\"center\">".$data_hospital["gred"]."</td>";
                    echo "<td style=\"width:16.3%\" align=\"center\">".$data_hospital["bil_waran"]."</td>";
                    echo "<td style=\"width:19%\" align=\"center\">".$data_hospital["bil_isi"]."</td>";
                    echo "<td style=\"width:21%\" align=\"center\">".$data_hospital["bil_kosong"]."</td>";
                ...
                // $edit_icon = "<a href='edit-hospital.php?id= {$id}' class='btn-sm btn-primary float-center'><i class='fa fa-edit '></i></a>",
                // $delete_icon = " <a href='delete-hospital.php?id={$id}' id='bin' class='btn-sm btn-primary float-center'><i class='fa fa-trash '></i></a>",
            ...
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php 
                            // bilangan waran perjawatan
                            $total_waran = "SELECT SUM(bil_waran) FROM hospital";
            ...
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php 
                            // bilangan pengisian
                            $total_isi = "SELECT SUM(bil_isi) FROM hospital";
            ...
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php 
                            //bilangan kekosongan
                            $total_kosong = "SELECT SUM(bil_kosong) FROM hospital";
