...
<div class="dropdown">
  ...
  <button type="button"  class="btn btn-secondary dropdown-toggle" style="width: 200px; background-color:#7571f9" >Institusi & Agensi</button> 
...
<div class="container bg-white shadow">
    ...
    <table class="table datatable">
            ...
            //   $results = mysqli_query($conn, $query);
              ...
              $sql = "SELECT * FROM data_institusiagensi INNER JOIN institusiagensi ON data_institusiagensi.id = institusiagensi.id_institusiagensi";  
              $results = mysqli_query($conn, $sql);
                    while($data_institusiagensi=mysqli_fetch_array($results)){
                    $id=$data_institusiagensi["id"];
                    $i++;
                    echo "<tr>";
                    //echo "<td>".$i."</td>";
                    echo "<td style=\"width:24.3%\">".$data_institusiagensi["institusiagensi"]."</td>";
                    echo "<td style=\"width:9%\" align=\"center\">".$data_institusiagensi["gred"]."</td>";
                    echo "<td style=\"width:16.3%\" align=\"center\">".$data_institusiagensi["bil_waran"]."</td>";
                    echo "<td style=\"width:19%\" align=\"center\">".$data_institusiagensi["bil_isi"]."</td>";
                    echo "<td style=\"width:21%\" align=\"center\">".$data_institusiagensi["bil_kosong"]."</td>";
