...
?>
    ...
    ?>
             ...
             <select name="bahagian" style="width:500px;font-size:15px;">
             <!-- <option>Pilih bahagian</option>  -->
             <option selected disabled> --Pilih Bahagian--</option>
             <?php $results = mysqli_query($conn, "SELECT * FROM data_bahagian ORDER BY bahagian ASC"); ?>
        ...
        if( $_SERVER["REQUEST_METHOD"] == "POST" ){
            ...
            if( !empty($gred) && !empty($bil_waran) && (-1<=($bil_isi)) && (($bil_waran) >= ($bil_isi)) ){
                ...
                require_once "../connection.php";
                    ...
                    $sql = "INSERT INTO bahagian ( id_bahagian, gred, bil_waran, bil_isi, bil_kosong ) VALUES( '$bahagian' , '$gred' , '$bil_waran', '$bil_isi' , '$bil_kosong')  ";
                    $result = mysqli_query($conn , $sql);
                    if($result){
                     $gred = $bil_waran = $bil_isi = $bil_kosong = $bahagian = "";
                        echo "<script>
                        $(document).ready( function(){
                            $('#showModal').modal('show');
                            $('#modalHead').hide();
                            $('#linkBtn').attr('href', 'manage-bahagian.php');
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-4 shadow">                       
                                    <h4 class="text-center">Tambah Bilangan Waran bahagian Kerajaan</h4>
