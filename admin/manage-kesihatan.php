    ...
    <table class="table datatable">
            ...
            //   $results = mysqli_query($conn, $query);
              ...
              $results = mysqli_query($conn, $sql);
                    ...
                    echo "<td align=\"center\">","<a class=\"btn-sm btn-primary\" href=\"edit-kesihatan.php?id= {$id}\" role=\"button\"><i class=\"fa fa-edit\"></i></a>"
                    ," &nbsp;	<a href=\"javascript:void(0)\" class=\"btn-sm btn-danger delete_btn_ajax\" role=\"button\"><i class=\"fa fa-trash\"></i></a>";
                    ?><input type="hidden" class="delete_id_value" value="<?php echo $data_kesihatan['id'] ?>"><?php
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    if(response == 200)
                                    {
                                        window.location.href="alert-kesihatan.php";
                                    }
