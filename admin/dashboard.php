...
<div class="dropdown">
  ...
  <button type="button"  class="btn btn-secondary dropdown-toggle" style="width: 200px; background-color:#7571f9" >--Sila Pilih--</button> 
...
<?php
        ...
        $bil_waran  ="SELECT * FROM hospital";
        $total_waran = mysqli_query($conn , $bil_waran);

        // bilangan pengisian
        $bil_isi = "SELECT * FROM hospital";
        $total_isi = mysqli_query($conn , $bil_isi);

        // bilangan kekosongan
        $bil_kosong = "SELECT * FROM hospital";
...
<?php
    ...
    ?>
             ...
             <button type="button"  class="btn btn-dark" li><a href="./manage-bahagian.php" >BAHAGIAN </a></li></button> 
             <button type="button" class="btn btn-outline-dark"li><a href="./manage-agensi.php" >INSTITUSI & AGENSI </a></li></button> 
             <button type="button" class="btn btn-outline-dark"li><a href="./manage-jkn.php" >JABATAN KESIHATAN NEGERI </a></li></button> 
             <button type="button"  class="btn btn-outline-dark" li><a href="./manage-bahagian.php" >PEJABAT KESIHATAN DAERAH </a></li></button> 
             <button type="button" class="btn btn-outline-dark"li><a href="./manage-agensi.php" >HOSPITAL KERAJAAN </a></li></button> <br> <br>
             <button type="button" class="btn btn-outline-dark"li><a href="./manage-jkn.php" >KLINIK KESIHATAN KERAJAAN </a></li></button> 
             <button type="button"  class="btn btn-outline-dark" li><a href="./manage-bahagian.php" >KLINIK KOMUNITI </a></li></button>  
             <button type="button" class="btn btn-outline-dark"li><a href="./manage-agensi.php" >KLINIK PERGIGIAN KERAJAAN </a></li></button> -->
    ...
    <table class="table datatable">
            ...
            //   $results = mysqli_query($conn, $query);
              ...
              $results = mysqli_query($conn, $sql);
                ...
                // $edit_icon = "<a href='edit-bahagian.php?id= {$id}' class='btn-sm btn-primary float-center'><i class='fa fa-edit '></i></a>",
                // $delete_icon = " <a href='delete-bahagian.php?id={$id}' id='bin' class='btn-sm btn-primary float-center'><i class='fa fa-trash '></i></a>",
