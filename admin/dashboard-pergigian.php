...
<div class="dropdown">
  ...
  <button type="button"  class="btn btn-secondary dropdown-toggle" style="width: 200px; background-color:#7571f9" >Klinik Pergigian Kerajaan</button> 
...
<?php
        ...
        $bil_waran  ="SELECT * FROM pergigian";
        $total_waran = mysqli_query($conn , $bil_waran);

        // bilangan pengisian
        $bil_isi = "SELECT * FROM pergigian";
        $total_isi = mysqli_query($conn , $bil_isi);

        // bilangan kekosongan
        $bil_kosong = "SELECT * FROM pergigian";
...
<div class="container bg-white shadow">
    <div class="py-4 mt-5"> 
    <div class='text-center pb-2'><h4>Bilangan Waran Klinik Pergigian Kerajaan</h4></div>
    ...
    <table class="table datatable">
                ...
                <!-- <th>No.</th> -->
                <th>Klinik Pergigian Kerajaan</th>
                <th>Gred</th>
            ...
            //   $results = mysqli_query($conn, $query);
              ...
              $sql = "SELECT * FROM data_pergigian INNER JOIN pergigian ON data_pergigian.id = pergigian.id_pergigian";  
              $results = mysqli_query($conn, $sql);
                    while($data_pergigian=mysqli_fetch_array($results)){
                    $id=$data_pergigian["id"];
                    $i++;
                    echo "<tr>";
                    //echo "<td>".$i."</td>";
                    echo "<td style=\"width:24.3%\">".$data_pergigian["pergigian"]."</td>";
                    echo "<td style=\"width:9%\" align=\"center\">".$data_pergigian["gred"]."</td>";
                    echo "<td style=\"width:16.3%\" align=\"center\">".$data_pergigian["bil_waran"]."</td>";
                    echo "<td style=\"width:19%\" align=\"center\">".$data_pergigian["bil_isi"]."</td>";
                    echo "<td style=\"width:21%\" align=\"center\">".$data_pergigian["bil_kosong"]."</td>";
                ...
                // $edit_icon = "<a href='edit-pergigian.php?id= {$id}' class='btn-sm btn-primary float-center'><i class='fa fa-edit '></i></a>",
                // $delete_icon = " <a href='delete-pergigian.php?id={$id}' id='bin' class='btn-sm btn-primary float-center'><i class='fa fa-trash '></i></a>",
            ...
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php 
                            // bilangan waran perjawatan
                            $total_waran = "SELECT SUM(bil_waran) FROM pergigian";
            ...
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php 
                            // bilangan pengisian
                            $total_isi = "SELECT SUM(bil_isi) FROM pergigian";
            ...
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php 
                            //bilangan kekosongan
                            $total_kosong = "SELECT SUM(bil_kosong) FROM pergigian";
