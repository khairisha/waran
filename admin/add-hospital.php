...
?>
    ...
    ?>
             ...
             <select name="hospital" style="width:500px;font-size:15px;">
             <option selected disabled> --Pilih Hospital Kerajaan--</option>
             <!-- <option>Pilih Hospital</option>  -->
             <?php $results = mysqli_query($conn, "SELECT * FROM data_hospital"); ?>
        ...
        if( $_SERVER["REQUEST_METHOD"] == "POST" ){
            ...
            if( !empty($gred) && !empty($bil_waran) && (-1<=($bil_isi)) && (($bil_waran) >= ($bil_isi)) ){
                ...
                require_once "../connection.php";
                    ...
                    $sql = "INSERT INTO hospital ( id_hospital, gred, bil_waran, bil_isi, bil_kosong ) VALUES( '$hospital' , '$gred' , '$bil_waran', '$bil_isi' , '$bil_kosong')  ";
                    $result = mysqli_query($conn , $sql);
                    if($result){
                     $gred = $bil_waran = $bil_isi = $bil_kosong = $hospital = "";
                        echo "<script>
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-4 shadow">                       
                                    <h4 class="text-center">Tambah Bilangan Waran Hospital Kerajaan</h4>
