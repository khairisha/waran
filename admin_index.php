            ...
            <div class="row justify-content-center h-100">
                <div class="col-xl-6">
                    <div class="form-input-content">
                        <div class="card login-form mt-200">
                            <div class="card-body shadow">  
                               
                                <h2 class="text-center pb-4">SISTEM WARAN PERJAWATAN</h2>
                                <h6 class="text-center pb-4">Sila Pilih</h6>

                                <div class="container mt-4">

                                  <div class="btn-toolbar justify-content-between">
                                        <div class="btn-group">
                                            <a href="admin/registration.php" class="btn btn-primary btn-lg">Daftar</a>
                                        </div>

                                        <div class="btn-group">
                                            <a href="admin/login.php" class="btn btn-primary btn-lg">Log Masuk</a>
                                        </div>
