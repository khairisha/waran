...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=98657242ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=data_bahagian">`waran_perjawatan`.`data_bahagian`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=bahagian">`waran_perjawatan`.`bahagian`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__export_templates">`phpmyadmin`.`pma__export_templates`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=admin">`waran_perjawatan`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=institusiagensi">`waran_perjawatan`.`institusiagensi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=data_institusiagensi">`waran_perjawatan`.`data_institusiagensi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=hospital">`waran_perjawatan`.`hospital`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=jkn">`waran_perjawatan`.`jkn`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=kesihatan">`waran_perjawatan`.`kesihatan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=waran_perjawatan&table=komuniti">`waran_perjawatan`.`komuniti`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4c557048653b2c6d63403c522c2d4072">
