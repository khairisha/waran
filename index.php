                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-100">
                            <div class="card-body shadow">  
                                ...
                                <h2 class="text-center pb-4">WARAN PERJAWATAN</h2>
                                ...
                                <div class="container mt-4">
                                  ...
                                  <div class="btn-toolbar justify-content-between">
                                        <div class="btn-group">
                                            <a href="emp_index.php" class="btn btn-primary btn-lg">Staff</a>
                                        </div>

                                        <div class="btn-group">
                                            <a href="admin_index.php" class="btn btn-primary btn-lg">Admin</a>
                                        </div>
